...
var g_tr_i_colors = {
    ...
    row_alternate:    _RGB(35, 35, 35),
    row_pressed:      g_theme.colors.panel_line_selected,
    row_pressed_rect: _RGB(80, 80, 80),
    line_color:       g_theme.colors.panel_line,
    info_name:        _RGB(160, 162, 164),
    ...
    this.initialize_list = function () {
        ...
        if (cur_metadb) {
            ...
            if (fileInfo) {
                ...
                alpha_timer = new _alpha_timer(this.cnt.rows, function (row) {
...
function Row(x, y, w, h, metadb_arg, tag_name_arg, value_text_arg) {
    ...
    // this is actually press_alpha, but _alpha_timer expects item.hover_alpha
    this.hover_alpha = 0;
